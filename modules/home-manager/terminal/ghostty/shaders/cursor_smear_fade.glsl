...
const vec4 TRAIL_COLOR = vec4(0.784, 0.753, 0.576, 0.5);// vec4(0.784, 0.753, 0.576, 1.0); //vec4(1., 1., 0., 1.0);
const float DURATION = 0.25; // SECONDS; I would just like to make this i little less intense
// doies this reduce the amount of black in the cursor
